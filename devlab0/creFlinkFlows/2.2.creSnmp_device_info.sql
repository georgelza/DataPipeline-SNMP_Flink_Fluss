...
CREATE TABLE hive.snmp.snmp_device_info_mysql (
    ...
    'table-name'            = 'snmp_device_info_mysql',                     -- The table name in your relational database
    'username'              = 'dbadmin',                                    -- Replace with your DB username
...
CREATE TABLE hive.snmp.snmp_device_info_pg (
     device_id                  VARCHAR(255) PRIMARY KEY NOT ENFORCED          -- Unique identifier for the device
    ,ip_address                 VARCHAR(45) NOT NULL                           -- IP address of the device (IPv4 or IPv6)
    ,hostname                   VARCHAR(255)                                   -- Hostname of the device
    ,device_location            VARCHAR(1000)                                  -- Physical location of the device
    ...
    'connector'             = 'jdbc',
    'url'                   = 'jdbc:postgresql://postgressnmp:5432/snmp',   -- Key Change: 'jdbc:postgresql' and default port 5432
    'table-name'            = 'public.snmp_device_info_pg',                 -- Key Change: Often includes schema, e.g., 'public.your_table'
    'username'              = 'dbadmin',
    'password'              = 'dbpassword',
